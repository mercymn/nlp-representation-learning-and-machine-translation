...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint-path",
        type=Path,
        default=Path("C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\models\\nmt_part2(1).model"),
    ...
    parser.add_argument(
        "--model-config",
        type=Path,
        default=Path("C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\cw2_2025_2026-students-main\\part2\\model_config.yaml"),
    ...
    parser.add_argument(
        "--test-source-file",
        type=Path,
        default=Path("cw2_2025_2026-students-main/multi30k_data/test_2016_flickr.en"),
    ...
    parser.add_argument(
        "--test-target-file",
        type=Path,
        default=Path("cw2_2025_2026-students-main/multi30k_data/test_2016_flickr.fr"),
    ...
    parser.add_argument(
        "--output-file",
        type=Path,
        default=Path("outputs", "results_part2_large.json"),
