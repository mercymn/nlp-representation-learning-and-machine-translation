            ...
            if train_iter % train_config["valid_niter"] == 0 and train_iter > 0:
                ...
                with torch.inference_mode():
                    ...
                    if val_loss < best_val_loss:
                        ...
                        torch.save(
                            model.state_dict(),
                            str(Path(args.checkpoint_path, "nmt_part2(1).model")),
                        )
                        # Also save the optimizer
                        torch.save(
                            optimizer.state_dict(),
                            str(Path(args.checkpoint_path, "nmt_part2(1).model.optim")),
                        )
                    else:
                        patience -= 1
...
def parse_args():
    ...
    parser.add_argument(
        "--model-config",
        type=Path,
        default=Path("config", "C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\cw2_2025_2026-students-main\\part2\\model_config.yaml"),
    ...
    parser.add_argument(
        "--train-config",
        type=Path,
        default=Path("config", "C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\cw2_2025_2026-students-main\\part2\\train_config.yaml"),
    ...
    parser.add_argument(
        "--train-source-file",
        type=Path,
        default=Path("..", "multi30k_data", "C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\cw2_2025_2026-students-main\\multi30k_data\\train.en"),
    ...
    parser.add_argument(
        "--train-target-file",
        type=Path,
        default=Path("..", "multi30k_data", "C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\cw2_2025_2026-students-main\\multi30k_data\\train.fr"),
    ...
    parser.add_argument(
        "--dev-source-file",
        type=Path,
        default=Path("..", "multi30k_data", "C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\cw2_2025_2026-students-main\\multi30k_data\\val.en"),
    ...
    parser.add_argument(
        "--dev-target-file",
        type=Path,
        default=Path("..", "multi30k_data", "C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\cw2_2025_2026-students-main\\multi30k_data\\val.fr"),
    ...
    parser.add_argument(
        "--vocab-file",
        type=Path,
        default=Path("vocab", "C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\vocab\\vocab.json"),
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path("vocab", "C:\\Users\\chris\\Downloads\\cw2_2025_2026-students-main\\vocab\\spm.model"),
